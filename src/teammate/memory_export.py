"""`teammate memory-export` — departing-engineer handover artifact.
...
Differences from :mod:`teammate.memory_import`:
...
The classifier is the same one :mod:`teammate.memory_import` uses; we
...
def _render_handover(plan: ExportPlan) -> str:
    ...
    lines.append(
        ...
        "useful entries into the team brain (`teammate memory-import` "
    ...
    lines.append("")
    lines.append(
        "_Generated by `teammate memory-export`. If you spot something "
