...
`teammate validate` produces an "orphan_files" warning that lists
...
from teammate.agent.base import OK, RoutineConfig, RoutineResult
from teammate.validate import _check_orphan_files, _iter_markdown
...
def _is_canonical_or_referenced(brain_root: Path, path: Path) -> bool:
    ...
    """
    from teammate.validate import _is_canonical
