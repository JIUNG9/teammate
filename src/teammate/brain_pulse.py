"""``teammate brain-pulse`` — the engineer's morning ritual.
...
from teammate.agent._sync_common import parse_frontmatter
...
def collect(
    ...
    *,
    ...
    # Default: brain-staged drafts live in ``<brain>/.teammate-agent/draft-prs/``.
    if staging_dir is None:
        staging_dir = brain_root / ".teammate-agent" / "draft-prs"
